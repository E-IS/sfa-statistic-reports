...
sequences_AP=read.csv(fichier_algopesca_sequences,sep="\t",dec = ".",col.names = c("PROGRAM_FK","VESSEL_FK","SECT_LOCATION_LEVEL_FK","SECT_LABEL","REG_LOCATION_COUNTRY_LABEL","REG_LOCATION_LEVEL_FK","REG_LOCATION_LABEL","START_DATE_TIME","END_DATE_TIME","FISHING_TIME_VESSEL","ROUTE_TIME_VESSEL","UNKNOWN_TIME_VESSEL"))
...
positions_AP=read.csv(fichier_algopesca_positions,sep="\t",col.names = c("ID","VESSEL_FK","INT_REGISTRATION_CODE","POSITION_DATE","LONGITUDE","LATITUDE","DIRECTION","DEPTH","INST_SPEED","AVG_SPEED","LOCATION_LABEL","LOCATION_NAME","LOCATION_DIST","IS_FISHING"))
...
write.table(marees_AP_finales,file="Données/MAREES_VMS_SORTIE_ALGOPESCA.csv",dec=".",sep=";",row.names = F)
